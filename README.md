...
This library is available via [NuGet](https://nuget.org/). You can add OpenDMA.Api to any .NET using...

#### ...the .NET CLI
```
dotnet add package OpenDMA.Api
```

#### ...Visual Studio
1. Right-click your project → **Manage NuGet Packages...**
2. Search for **OpenDMA.Api**
3. Click **Install**
...
There is a generic [OpenDMA REST Client for C# / .net](https://github.com/OpenDMA/opendma-csharp-remote)
